...
const MiniNav = () => {
  ...
  return (
    <div className=" p-2 sticky top-0 z-10 bg-black overflow-x-auto flex items-center gap-4">
      {minibarBtn.map((item) => {
        return (
          <button className=" min-w-fit text-xs sm:text-sm rounded-md sm:rounded-xl hover:bg-zinc-800 hover:bg-opacity-50 p-2 px-4 sm:px-6 list-none border border-zinc-800 bg-zinc-900 bg-opacity-50"
